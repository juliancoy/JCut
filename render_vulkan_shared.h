...
inline constexpr float kVulkanEffectModeRecursiveZoomTile = 30.0f;
inline constexpr float kVulkanEffectModeRecursiveZoomTunnel = 31.0f;
inline constexpr float kVulkanEffectModeRecursiveZoomMirrorBox = 32.0f;
inline constexpr float kVulkanEffectModeRecursiveZoomSpiral = 33.0f;
