...
nlohmann::json toJson(const RenderRequestCore& request)
{
    return nlohmann::json{
        ...
        {"backgroundFillEffect", request.backgroundFillEffect},
        {"backgroundFillOpacity", request.backgroundFillOpacity},
        {"backgroundFillBrightness", request.backgroundFillBrightness},
        {"backgroundFillSaturation", request.backgroundFillSaturation},
...
nlohmann::json toJson(const RenderProgressCore& progress)
{
    return nlohmann::json{
        ...
        {"cudaExternalMemoryStatus", progress.cudaExternalMemoryStatus},
        {"exportPathFallbackReason", progress.exportPathFallbackReason},
        {"cudaExternalTransfer", progress.cudaExternalTransfer},
        {"cudaExternalMemorySupported", progress.cudaExternalMemorySupported},
...
nlohmann::json toJson(const RenderResultCore& result)
{
    return nlohmann::json{
        ...
        {"cudaExternalMemoryStatus", result.cudaExternalMemoryStatus},
        {"exportPathFallbackReason", result.exportPathFallbackReason},
        {"cudaExternalTransfer", result.cudaExternalTransfer},
        {"cudaExternalMemorySupported", result.cudaExternalMemorySupported},
