        ...
        [this]() {
            ...
            return QJsonObject{
                ...
                {QStringLiteral("last_preview_update_request_ms"),
                 presentationTelemetry.lastPreviewUpdateRequestMs},
                {QStringLiteral("last_preview_update_event_ms"),
                 presentationTelemetry.lastPreviewUpdateEventMs},
                {QStringLiteral("last_preview_update_delivered_ms"),
                 presentationTelemetry.lastPreviewUpdateDeliveredMs},
                {QStringLiteral("last_presented_ms"),
                 presentationTelemetry.lastPresentedMs},
                {QStringLiteral("preview_update_posted"),
                 presentationTelemetry.previewUpdatePosted},
                {QStringLiteral("preview_frame_in_progress"),
                 presentationTelemetry.previewFrameInProgress},
                {QStringLiteral("preview_update_dirty"),
                 presentationTelemetry.previewUpdateDirty},
                {QStringLiteral("preview_window_exposed"),
                 presentationTelemetry.previewWindowExposed},
