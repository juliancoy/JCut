...
- `speaker_facedetections.py`, `speaker_face_candidates.py`, `sync_detector.py`, `docker_face_detector.py` — External ML/analysis helper scripts. Position: `L5`.
- `speaker_facedetections.dockerfile`, `syncnet.dockerfile` — Containerized toolchain definitions. Position: `L5`.
