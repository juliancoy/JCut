...
void EditorWindow::createOutputTab()
{
    m_outputTab = std::make_unique<OutputTab>(
        OutputTab::Widgets{
            ...
            m_masterOutputSubtitleOffsetMsSpin, m_renderButton},
...
void EditorWindow::createSpeakersTab()
{
    ...
    m_speakersTab = std::make_unique<SpeakersTab>(
        SpeakersTab::Widgets{
            ...
            m_inspectorPane->selectedSpeakerGradingEnabledCheckBox(),
            m_inspectorPane->selectedSpeakerBrightnessSpin(),
            m_inspectorPane->selectedSpeakerContrastSpin(),
            m_inspectorPane->selectedSpeakerSaturationSpin(),
...
void EditorWindow::createEffectsTab()
{
    m_effectsTab = std::make_unique<EffectsTab>(
        EffectsTab::Widgets{
            ...
            m_inspectorPane->effectPresetCategoryCombo(),
            m_inspectorPane->effectPresetCombo(),
            m_inspectorPane->effectPresetPreviousButton(),
            m_inspectorPane->effectPresetNextButton(),
            ...
            m_inspectorPane->maskBoundingBoxSection(),
            m_inspectorPane->tilingUseMaskBoundsCheck(),
            m_inspectorPane->tilingMaskIslandSigmaSpin(),
            m_inspectorPane->maskBoundingBoxPreviewCheck(),
            m_inspectorPane->directionalEchoControlsWidget(),
            m_inspectorPane->directionalEchoDirectionDial(),
            m_inspectorPane->directionalEchoDirectionValueLabel(),
            m_inspectorPane->directionalEchoSpreadDial(),
            m_inspectorPane->directionalEchoSpreadValueLabel(),
            m_inspectorPane->directionalEchoHueDial(),
            m_inspectorPane->directionalEchoHueValueLabel(),
            m_inspectorPane->directionalEchoSummaryLabel(),
            m_inspectorPane->stepRepeatFillControlsWidget(),
            m_inspectorPane->stepRepeatFillGuideScaleDial(),
            m_inspectorPane->stepRepeatFillGuideScaleValueLabel(),
            m_inspectorPane->stepRepeatFillLumaMatchDial(),
            m_inspectorPane->stepRepeatFillLumaMatchValueLabel(),
            m_inspectorPane->stepRepeatFillHueMatchDial(),
            m_inspectorPane->stepRepeatFillHueMatchValueLabel(),
            m_inspectorPane->stepRepeatFillSummaryLabel(),
            nullptr},
...
void EditorWindow::createMaskTab()
{
    m_maskTab = std::make_unique<MaskTab>(
        MaskTab::Widgets{
            ...
            m_inspectorPane->maskEdgeGrayAmountSpin(),
            m_inspectorPane->maskEdgeGrayWidthSpin(),
            m_inspectorPane->maskEdgeGrayGammaSpin(),
            m_inspectorPane->maskDilateSpin(),
            m_inspectorPane->maskErodeSpin(),
            m_inspectorPane->maskBlurSpin(),
            m_inspectorPane->maskTemporalStabilizeCheck(),
            m_inspectorPane->maskTemporalStabilizeStrengthSpin(),
            m_inspectorPane->maskTemporalStabilizeMotionRadiusSpin(),
...
void EditorWindow::createTitlesTab()
{
    m_titlesTab = std::make_unique<TitlesTab>(
        TitlesTab::Widgets{
            ...
            m_inspectorPane->titleLifetimeAnimationCombo(),
            m_inspectorPane->titleLifetimeAnimationAmountSpin(),
            m_inspectorPane->applyTitleLifetimeAnimationButton(),
...
void EditorWindow::createVideoKeyframeTab()
{
    m_videoKeyframeTab = std::make_unique<VideoKeyframeTab>(
        VideoKeyframeTab::Widgets{
            ...
            m_inspectorPane->sourceTransformLockCheckBox(),
